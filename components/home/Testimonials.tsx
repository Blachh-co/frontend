...
export function Testimonials() {
  ...
  return (
    <section className="bg-[#F7F2ED] flex justify-center px-5 py-16 md:px-8 md:py-20 xl:h-243 xl:items-center xl:py-0">
      ...
      <div className="flex w-full max-w-5xl flex-col gap-12 xl:h-full xl:max-w-7xl xl:flex-row xl:items-center xl:justify-between">
        ...
        {/* LEFT */}
        <div className="flex flex-col gap-8 xl:h-full xl:justify-center xl:gap-y-56">
          
          <div className="flex flex-col gap-3">
            <h1 className="font-libre text-[2rem] leading-tight text-[#1C1C1A] md:text-[2.625rem] md:leading-12">
              Loved by <span className="text-[#9BB845]">matcha</span><br />
              <span className="text-[#9BB845]">lovers</span> across the<br />
              world.
            </h1>

            <p className="text-black font-hanken text-sm leading-6 md:leading-4.25">
